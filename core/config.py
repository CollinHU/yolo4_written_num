...
__C.YOLO.CLASSES              = "./clockNumData/mnist.names"
...
__C.TRAIN.ANNOT_PATH          = "./clockNumData/train.txt"
...
__C.TEST.ANNOT_PATH           = "./clockNumData/test.txt"
__C.TEST.BATCH_SIZE           = 4
__C.TEST.INPUT_SIZE           = 224
__C.TEST.DATA_AUG             = False
__C.TEST.DECTECTED_IMAGE_PATH = "./clockNumData/test/"
...
YOLO_COCO_CLASSES           = "clockNumData/mnist.names"
...
TRAIN_CLASSES               = "clockNumData/mnist.names"
TRAIN_ANNOT_PATH            = "clockNumData/train.txt"
TRAIN_LOGDIR                = "log"
...
# TEST options
TEST_ANNOT_PATH             = "clockNumData//test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 224
TEST_DATA_AUG               = False
